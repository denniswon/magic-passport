...
/// @title TestPassportERC721NFT_Integration_ColdAccess
/// @notice Tests Passport smart account functionalities with ERC721 token transfers (Cold Access)
contract TestPassportERC721NFT_Integration_ColdAccess is PassportTest_Base {
    MockNFT ERC721NFT;
    ...
    /// @notice Tests sending ERC721 tokens from an already deployed Passport smart account with cold access
    function test_Gas_ERC721NFT_DeployedPassport_Transfer_Cold() public checkERC721NFTBalanceCold(recipient) {
        ...
        measureAndLogGas("15::ERC721::transferFrom::Passport::Deployed::ColdAccess", userOps);
    }

    /// @notice Tests deploying Passport and transferring ERC721 tokens using a paymaster with cold access
    ...
    /// @notice Tests deploying Passport and transferring ERC721 tokens using deposited funds without a paymaster with cold access
    ...
    function test_Gas_ERC721NFT_DeployPassportWithPreFundedETH_Cold() public checkERC721NFTBalanceCold(recipient) {
        ERC721NFT.mint(preComputedAddress, tokenId);
    ...
    function test_Gas_ERC721NFT_DeployedPassport_Transfer_WithPaymaster_Cold()
        public
        ...
        checkPaymasterBalance(address(paymaster))
    {
        ...
        measureAndLogGas("23::ERC721::transferFrom::Passport::WithPaymaster::ColdAccess", userOps);
    }
}
