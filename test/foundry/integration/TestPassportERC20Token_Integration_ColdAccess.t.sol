...
/// @title TestPassportERC20Token_Integration_ColdAccess
/// @notice Tests Passport smart account functionalities with ERC20 token transfers (Cold Access)
contract TestPassportERC20Token_Integration_ColdAccess is PassportTest_Base {
    ...
    /// @notice Tests sending ERC20 tokens from an already deployed Passport smart account with cold access
    function test_Gas_ERC20Token_DeployedPassport_Transfer_Cold() public checkERC20TokenBalanceCold(recipient, amount) {
        ...
        measureAndLogGas("3::ERC20::transfer::Passport::Deployed::ColdAccess", userOps);
    }

    /// @notice Tests deploying Passport and transferring ERC20 tokens using a paymaster with cold access
    ...
    /// @notice Test deploying Passport and transferring ERC20 tokens using deposited funds without a paymaster with cold access
    ...
    /// @notice Test sending ETH to the Passport account before deployment and then deploy
    function test_Gas_DeployPassportWithPreFundedETH() public checkERC20TokenBalanceCold(recipient, amount) {
    ...
    function test_Gas_ERC20Token_DeployedPassport_Transfer_WithPaymaster_Cold()
        public
        checkERC20TokenBalanceCold(recipient, amount)
        checkPaymasterBalance(address(paymaster))
    {
        ...
        measureAndLogGas("11::ERC20::transfer::Passport::WithPaymaster::ColdAccess", userOps);
    }
}
