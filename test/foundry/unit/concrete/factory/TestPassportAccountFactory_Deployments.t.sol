...
/// @title TestPassportAccountFactory_Deployments
/// @notice Tests for deploying accounts using the PassportAccountFactory.
contract TestPassportAccountFactory_Deployments is PassportTest_Base {
    ...
    function test_Constructor_RevertIf_ImplementationIsZero() public {
        ...
        // Try deploying the PassportAccountFactory with an implementation address of zero
        new PassportAccountFactory(zeroAddress, address(this));
    }
    ...
    function test_RevertIf_NoValidatorDuringInitialization() public {
        ...
        bytes memory _initData = BOOTSTRAPPER.getInitPassportScopedCalldata(emptyValidators, hook, REGISTRY, ATTESTERS, THRESHOLD);
