...
/// @title TestPassport_Hook_Uninstall
/// @notice Tests for handling hooks emergency uninstall
contract TestPassport_Hook_Emergency_Uninstall is TestModuleManagement_Base {
    ...
    function test_EmergencyUninstallHook_Initiate_Success() public {
        ...
        bytes memory emergencyUninstallCalldata = abi.encodeWithSelector(Passport.emergencyUninstallHook.selector, address(HOOK_MODULE), "");
